...
from utils.env_future import GakuenIdolMasterEnv
from utils import agent_future
from utils import cards_future
import torch
...
model = A2C.load("ppo_gakuen_idol_master", device='cpu', env=env)
